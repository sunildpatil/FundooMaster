...
public class UserServiceImpl implements UserService {
	...
	public void register(UserRegistrationDTO userRegistrationDTO) throws RegistraionException {
		...
		producerEmail.send(emailObj);
		
		userHelper.insert(dbKey, Integer.toString(user.getId()),user);	
	}
	...
	public void updateUser(UserRegistrationDTO userUpdateDTO) throws RegistraionException {
		...
		userByEmail.setFirstName(userUpdateDTO.getFirstName());
		userByEmail.setLastName(userUpdateDTO.getLastName());
		userByEmail.setEmail(userUpdateDTO.getEmail());
		userByEmail.setPassword(passwordEncoder.encode(userUpdateDTO.getPassword()));
		userByEmail.setContactNumber(userUpdateDTO.getContactNumber());

		userRepository.save(userByEmail);
		
		userHelper.update(dbKey, Integer.toString(userByEmail.getId()),userByEmail);
	...
	public void deleteUser(String email) throws RegistraionException {
		...
		int result = userRepository.deleteByid(userByEmail.getId());
		...
		userHelper.delete(dbKey, Integer.toString(userByEmail.getId()));
	}
